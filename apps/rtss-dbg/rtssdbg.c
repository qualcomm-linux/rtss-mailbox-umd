...
{
	int nRet;
	struct rtss_mb_handle txClientData = { 0 };
	struct rtss_mb_handle rxClientData = { 0 };
	struct rtss_mb_handle *pTxClientData = &txClientData;
	struct rtss_mb_handle *pRxClientData = &rxClientData;
